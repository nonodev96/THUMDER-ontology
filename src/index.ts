...
import Ontology, { InteractionProtocol } from "./_Core/Ontology";

import CFPSimulation from "./AgentAction/CFPSimulation";
import FileManagerAction, {
  CreateFolder,
  CreateFile,
  ModifyFolder,
  ModifyFile,
...
import {
  ...
  Client,
  Server,
} from "./Concept/AgentCommunication";
...
import {
  SubInform,
  IncidenceCommunication,
  ResultInstruction,
} from "./Predicate/SubInform";
